    ...
    <div class="min-w-full card card-outline-header-secondary">
      ...
      <div class="card-body">
        <div class="grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
          <div class="col-span-1 flex flex-col justify-center items-center p-2 border-[1px] border-gray-200 hover:border-secondary">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="fill-current w-7 h-7">
          ...
          <div class="col-span-1 flex flex-col justify-center items-center p-2 border-[1px] border-gray-200 hover:border-secondary">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 460 512" class="fill-current w-7 h-7">
              <!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
          ...
          <div class="col-span-1 flex flex-col justify-center items-center p-2 border-[1px] border-gray-200 hover:border-secondary">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="fill-current w-7 h-7">
              <!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
